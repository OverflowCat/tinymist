...
- [ ] 1.4 Sign the OHOS binary with the pinned `ohos-binary-sign` package dependency under QEMU before packaging and verify the signing step succeeds in GitHub Actions.
...
- [ ] 3.4 Resolve any VSIX target incompatibility without publishing a misleading Marketplace package, then verify downloadable signed OHOS Tinymist and Typst Preview VSIX artifacts are produced.
